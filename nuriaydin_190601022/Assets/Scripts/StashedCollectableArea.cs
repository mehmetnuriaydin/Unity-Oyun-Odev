...
public class StashedCollectableArea : MonoBehaviour
{
    public Collectable collectablePrefab;

    public List<Collectable> SpawnedCollectables = new List<Collectable>();
    //int _maxSpawnCount = StashedTrainArea.CollectedPrice;
    //[SerializeField]  int _maxSpawnCount;
     private float _spawnRadius = 8;

     private float _spawnPeriod = 0.3f;
